...
package com.shnwaz.lyramusic.innertube

import com.shnwaz.lyramusic.innertube.models.AccountInfo
...
import com.shnwaz.lyramusic.innertube.models.MediaInfo
...
import com.shnwaz.lyramusic.innertube.models.MusicCarouselShelfRenderer
...
import com.shnwaz.lyramusic.innertube.models.Runs
import com.shnwaz.lyramusic.innertube.models.SongItem
import com.shnwaz.lyramusic.innertube.models.WatchEndpoint
import com.shnwaz.lyramusic.innertube.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_ATV
import com.shnwaz.lyramusic.innertube.models.YouTubeClient
import com.shnwaz.lyramusic.innertube.models.YouTubeClient.Companion.WEB
import com.shnwaz.lyramusic.innertube.models.YouTubeClient.Companion.WEB_REMIX
import com.shnwaz.lyramusic.innertube.models.YouTubeLocale
import com.shnwaz.lyramusic.innertube.models.getContinuation
import com.shnwaz.lyramusic.innertube.models.getItems
import com.shnwaz.lyramusic.innertube.models.oddElements
import com.shnwaz.lyramusic.innertube.models.response.AccountMenuResponse
import com.shnwaz.lyramusic.innertube.models.response.BrowseResponse
import com.shnwaz.lyramusic.innertube.models.response.CreatePlaylistResponse
import com.shnwaz.lyramusic.innertube.models.response.GetQueueResponse
import com.shnwaz.lyramusic.innertube.models.response.GetSearchSuggestionsResponse
import com.shnwaz.lyramusic.innertube.models.response.GetTranscriptResponse
import com.shnwaz.lyramusic.innertube.models.response.NextResponse
import com.shnwaz.lyramusic.innertube.models.response.PlayerResponse
import com.shnwaz.lyramusic.innertube.models.response.SearchResponse
import com.shnwaz.lyramusic.innertube.pages.AlbumPage
import com.shnwaz.lyramusic.innertube.pages.ArtistItemsContinuationPage
import com.shnwaz.lyramusic.innertube.pages.ArtistItemsPage
import com.shnwaz.lyramusic.innertube.pages.ArtistPage
import com.shnwaz.lyramusic.innertube.pages.ChartsPage
import com.shnwaz.lyramusic.innertube.pages.BrowseResult
import com.shnwaz.lyramusic.innertube.pages.ExplorePage
import com.shnwaz.lyramusic.innertube.pages.HistoryPage
import com.shnwaz.lyramusic.innertube.pages.HomePage
import com.shnwaz.lyramusic.innertube.pages.LibraryContinuationPage
import com.shnwaz.lyramusic.innertube.pages.LibraryPage
import com.shnwaz.lyramusic.innertube.pages.MoodAndGenres
import com.shnwaz.lyramusic.innertube.pages.NewReleaseAlbumPage
import com.shnwaz.lyramusic.innertube.pages.NextPage
import com.shnwaz.lyramusic.innertube.pages.NextResult
import com.shnwaz.lyramusic.innertube.pages.PlaylistContinuationPage
import com.shnwaz.lyramusic.innertube.pages.PlaylistPage
import com.shnwaz.lyramusic.innertube.pages.RelatedPage
import com.shnwaz.lyramusic.innertube.pages.SearchPage
import com.shnwaz.lyramusic.innertube.pages.SearchResult
import com.shnwaz.lyramusic.innertube.pages.SearchSuggestionPage
import com.shnwaz.lyramusic.innertube.pages.SearchSummary
import com.shnwaz.lyramusic.innertube.pages.SearchSummaryPage
import com.shnwaz.lyramusic.innertube.utils.PoTokenGenerator
...
object YouTube {
    ...
    suspend fun search(query: String, filter: SearchFilter): Result<SearchResult> = runCatching {
        ...
        val musicShelfRenderer = response.contents?.tabbedSearchResultsRenderer?.tabs?.firstOrNull()
            ...
            ?.lastOrNull { !it.contents.isNullOrEmpty() }
        SearchResult(
    ...
    suspend fun albumSongs(playlistId: String, album: AlbumItem? = null): Result<List<SongItem>> = runCatching {
        ...
        val shelfRenderers = response.contents?.twoColumnBrowseResultsRenderer
            ?.secondaryContents
            ?.sectionListRenderer
            ?.contents
        val playlistShelf = shelfRenderers
            ?.asSequence()
            ?.mapNotNull { it.musicPlaylistShelfRenderer }
            ?.firstOrNull { it.contents.isNotEmpty() }
        val musicShelf = shelfRenderers
            ?.asSequence()
            ?.mapNotNull { it.musicShelfRenderer }
            ?.firstOrNull { !it.contents.isNullOrEmpty() }
        val shelfContents = playlistShelf?.contents ?: musicShelf?.contents
        ...
        var continuation = playlistShelf?.contents?.getContinuation()
            ...
            ?: musicShelf?.contents?.getContinuation()
            ?: musicShelf?.continuations?.getContinuation()
            ...
            val continuationItems =
                response.onResponseReceivedActions
                    ...
                    ?: response.continuationContents
                        ...
                        ?.contents
            val newSongs = continuationItems
                ?.getItems()
                ?.mapNotNull { AlbumPage.getSong(it, album) }
                .orEmpty()
