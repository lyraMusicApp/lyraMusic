...
import com.shnwaz.lyramusic.constants.*
import com.shnwaz.lyramusic.extensions.*
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(com.shnwaz.lyramusic.utils.GlobalLogTree())
        } catch (_: Exception) {}
