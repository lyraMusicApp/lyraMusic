...
import com.shnwaz.lyramusic.ui.component.MediaMetadataListItem
...
fun Queue(
    ...
    val togetherForcesLock =
        togetherSessionState is com.shnwaz.lyramusic.together.TogetherSessionState.Joined &&
                                                    ...
                                                    onClick = {
                                                        if (selection) {
                                                            ...
                                                            if (index == currentWindowIndex) {
                                                                ...
                                                                val joined =
                                                                    togetherSessionState as? com.shnwaz.lyramusic.together.TogetherSessionState.Joined
                                                                val isGuest = joined?.role is com.shnwaz.lyramusic.together.TogetherRole.Guest
                                                                if (isGuest) {
