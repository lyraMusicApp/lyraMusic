...
import com.shnwaz.lyramusic.canvas.OpenTuneCanvas
import com.shnwaz.lyramusic.canvas.CanvasArtwork
...
import com.shnwaz.lyramusic.constants.MaxCanvasCacheSizeKey
    ...
    LaunchedEffect(itemScrollOffset) {
        ...
        if (currentItem > currentMediaIndex && canSkipNext) {
            ...
            if (com.shnwaz.lyramusic.ui.screens.settings.DiscordPresenceManager.isRunning()) {
                try { com.shnwaz.lyramusic.ui.screens.settings.DiscordPresenceManager.restart() } catch (_: Exception) {}
            }
